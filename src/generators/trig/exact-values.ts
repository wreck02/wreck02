...
const FORMS: Form[] = [
  {
    ...
    mistakes: (f, a, b) => [
      ...
      { value: () => f.s(a).pow(2).add(f.c(b)), trap: 'squared only the first term' },
      { value: () => f.s(a).add(f.c(b).pow(2)), trap: 'squared only the second term' },
    ],
  ...
  },
  {
    ...
    mistakes: (f, a, b) => [
      ...
      { value: () => f.s(a).pow(2), trap: 'used the first angle twice' },
