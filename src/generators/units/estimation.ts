...
function airMassQ(rng: RNG): Generated | null {
  ...
  return estimate(rng, {
    ...
    mistakes: [
      ...
      { value: round((rho * l * w * h) / 100), trap: 'read the height in centimetres and used it as metres' },
    ],
...
function bathQ(rng: RNG): Generated | null {
  ...
  return estimate(rng, {
    ...
    mistakes: [
      ...
      { value: round(rho * l * w * (d / 100)), trap: 'read the depth in centimetres and used it as metres' },
    ],
...
function kettleEnergyQ(rng: RNG): Generated | null {
  ...
  return estimate(rng, {
    ...
    mistakes: [
      ...
      { value: round(m * c * (dT / 100)), trap: 'read the temperature rise in kelvin as a hundredth of its value' },
    ],
...
function atmosphereQ(rng: RNG): Generated | null {
  ...
  return estimate(rng, {
    ...
    mistakes: [
      ...
      { value: round(p * l * (h / 100)), trap: 'read one side of the wall in centimetres and used it as metres' },
    ],
...
function stairsQ(rng: RNG): Generated | null {
  ...
  return estimate(rng, {
    ...
    mistakes: [
      ...
      { value: round((m * 10 * (h / 100)) / t), trap: 'read the height in centimetres and used it as metres' },
    ],
